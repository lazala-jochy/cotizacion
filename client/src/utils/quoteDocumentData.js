/** Misma lógica que shared/quoteDocumentData.js (vista y PDF). */
...
export function filterQuoteItems(items) {
...
export function buildTotalsRows(quote) {
  const rows = [];
...
export function getDocumentTerms(quote, ejecutivoFallback = '') {
